...
! function(t, n) {
    ...
    function S(t) {
        for (var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "y", e = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i = Lt[n], o = t instanceof Element ? [t] : d(t), r = [], l = xt.createElement("div"), u = 0; u < o.length; u++) {
            var a = o[u];
            if (a[i] > 0 ? r.push(a) : (l.style.width = a.clientWidth + 1 + "px", l.style.height = a.clientHeight + 1 + "px", a.appendChild(l), a[i] = 1.5 / y(), a[i] > 0 && r.push(a), a[i] = 0, a.removeChild(l)), !e && r.length > 0) break
        }
        return r
    }
    ...
    function L(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
        if (!t || t && !t.getClientRects().length) return {
            top: 0,
            left: 0
        };
        ...
        if (e.width || e.height) {
            var i = {},
                o = null;
            if (null == n || g(n)) o = t.ownerDocument.documentElement, i.top = _t.pageYOffset, i.left = _t.pageXOffset;
            else {
                o = n;
                var r = o.getBoundingClientRect();
                i.top = r.top * -1 + o.scrollTop, i.left = r.left * -1 + o.scrollLeft
            }
            return {
    ...
    function Z(t, n, e, i, o) {
        var r = 1.70158,
            l = 0,
            u = i;
        return 0 === n ? e : 1 === (n /= o) ? e + i : (l || (l = .3 * o), u < ht(i) ? (u = i, r = l / 4) : r = l / (2 * dt) * pt(i / u), -(u * ct(2, 10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l)) + e)
    }
    ...
    function tt(t, n, e, i, o) {
        var r = 1.70158,
            l = 0,
            u = i;
        return 0 === n ? e : 1 === (n /= o) ? e + i : (l || (l = .3 * o), u < ht(i) ? (u = i, r = l / 4) : r = l / (2 * dt) * pt(i / u), u * ct(2, -10 * n) * st((n * o - r) * (2 * dt) / l) + i + e)
    }
    ...
    function nt(t, n, e, i, o) {
        var r = 1.70158,
            l = 0,
            u = i;
        return 0 === n ? e : 2 === (n /= o / 2) ? e + i : (l || (l = o * (.3 * 1.5)), u < ht(i) ? (u = i, r = l / 4) : r = l / (2 * dt) * pt(i / u), n < 1 ? -.5 * (u * ct(2, 10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l)) + e : u * ct(2, -10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l) * .5 + i + e)
    }
    ...
    if (Ot) {
        for (var qt = 0; qt < Mt.length && !Tt; ++qt) Tt = _t[Mt[qt] + "RequestAnimationFrame"], zt = _t[Mt[qt] + "CancelAnimationFrame"] || _t[Mt[qt] + "CancelRequestAnimationFrame"];
        Tt || (Tt = function(t) {
            var n = Date.now(),
                e = vt(0, 16 - (n - Rt)),
            ...
            return kt(t, [{
                ...
                value: function(t, n, e) {
                    ...
                    this.progress || (this.props = {
                        x: t,
                        y: n
                    }, this.options = e, this.easing = i(e.easing) ? e.easing : At[e.easing.replace("ease", "")], this.progress = !0, setTimeout(function() {
                ...
                value: function() {
                    ...
                    this.startTime = null, this.progress = !1, zt(this.rafId), t && (x(this.el, this.props.x, "x"), x(this.el, this.props.y, "y")), i(n) && (n.call(this), this.options.complete = null)
                }
            }, {
                key: "_loop",
                value: function(t) {
                    var n = this;
                    if (this.startTime || (this.startTime = t), !this.progress) return void this.stop(!1);
                    var e = this.el,
                        i = this.props,
                        o = this.options,
                        r = this.startTime,
                ...
                value: function(t, n) {
                    ...
                    if (this.options.quickMode) {
                        var i = I(this.el),
                            ...
                            r = o.width,
                            l = o.height;
                        ht(e.y - n) > l && (e.y = e.y > n ? n + l : n - l), ht(e.x - t) > r && (e.x = e.x > t ? t + r : t - r)
                    }
                    return e
                }
            }]), t
        ...
        Wt = function() {
            ...
            return kt(t, [{
                ...
                value: function(t) {
                    ...
                    if (!this.isSSR) {
                        var o = this.container,
                            ...
                            l = this._trigger,
                            u = e(t) && /^#/.test(t) ? t : null;
                        if (this._options = r, this._trigger = null, this._shouldCallCancelScroll = !1, this.stop(), !o) return this.log("Not found container element.");
                        var a = this.getScrollOffset(t, r);
                        if (!a) return this.log("Invalid parameter of distance. => " + t);
                        if (this.hook(r, "beforeScroll", a, l) === !1) return void(this._options = null);
                ...
                value: function(t) {
                    ...
                    else if (o(t)) 2 === t.length ? (i.top = t[0], i.left = t[1]) : (i.top = n ? t[0] : 0, i.left = n ? 0 : t[0]);
                    else if (l(t)) i.top = n ? t : 0, i.left = n ? 0 : t;
                    else {
                        if (!e(t)) return null;
                        var r = h(t);
                        if (/^\d+,\d+$/.test(r)) r = r.split(","), i.top = r[0], i.left = r[1];
                ...
                key: "hook",
                value: function(t, n) {
                    for (var e = t[n], o = arguments.length, r = Array(o > 2 ? o - 2 : 0), l = 2; l < o; l++) r[l - 2] = arguments[l];
                    if (i(e)) {
                ...
                value: function(t) {
                    for (var n = this.options, e = t.target; e && e !== xt; e = e.parentNode)
                        if (v(e, n.trigger)) {
                            ...
                            n = c({}, n, o), n.preventDefault && t.preventDefault(), n.stopPropagation && t.stopPropagation(), this._trigger = e, n.horizontalScroll && n.verticalScroll ? this.to(r, n) : n.verticalScroll ? this.toTop(r, n) : n.horizontalScroll && this.toLeft(r, n)
                        }
                }
            }, {
