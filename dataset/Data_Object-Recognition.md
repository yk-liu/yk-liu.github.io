...
# Lifelong Object Recognition Dataset

(L)ifel(O)ng {R}obotic V{IS}ion (OpenLORIS) - Object Recognition Dataset is designed for accelerating the lifelong/continual/incremental learning research and application，currently focusing on the common objects existing in the home scenario. 
...
![Objects under 12 level environment conditions](https://lifelong-robotic-vision.github.io/about/object.gif)
