...
1. Vector is (like in high school) a tuple of numbers;
2. Vector is a equivalent class of curves;
3. Vector is derivation.
...
## Vector is a tuple of numbers

When I think about vector on a manifold, I have the picture of some arrow tangent to the "surface" of manifold. Since in general, there is no way to define a "straight arrow" connecting two points, the vector cannot live on the manifold itself, but the collection of tangent spaces over the entire manifold, which is called tangent bundle.

<figure>
<img src="https://upload.wikimedia.org/wikipedia/commons/8/87/Tangent_bundle.svg" width="20%"><img src="https://upload.wikimedia.org/wikipedia/commons/8/87/Tangent_bundle.svg" width="20%">
 <figcaption>
 (a)Tangent bundle from Wikipedia
 </figcaption>
</figure>
