...
The word "tangent" cries for derivation. Besides the above definition of vector lacks necessary algebraic tools to perform calculations with.
...
This is a strange sentence. The definition can be quite a tongue-twister. Here it goes from [Nakahara](http://stringworld.ru/files/Nakahara_M._Geometry_topology_and_physics_2nd_ed..pdf):
