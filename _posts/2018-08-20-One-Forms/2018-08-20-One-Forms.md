...
But the tangent vector is on a manifold is in some sense a "directional derivative" $\Eqn{vector-as-directional-derivative}$, and the dual of "directional derivative" is a "gradient", and vice versa. 
